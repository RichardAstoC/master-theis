...
T(1) = y(21)^(-params(2));
T(2) = params(9)/(y(18)*100)*params(4)/(1-y(30));
T(3) = y(6)^(-1);
T(4) = (y(10)/y(12))^(params(4)-1);
T(5) = (1-params(12))/(1-y(30));
T(6) = 1/params(5)*T(5);
...
T(22) = (1-y(30))*y(13)*y(17)/params(4);
T(23) = y(6)*T(22);
T(24) = (y(12)/y(10))^(params(4)-1);
T(25) = params(4)/((1-y(30))*y(17));
T(26) = y(18)^params(9);
T(27) = T(7)*(1-y(30))*(params(4)-1)*T(26)/params(4);
