...
T(24) = (1-params(11))*y(13)*y(17)/params(4);
T(25) = y(6)*T(24);
T(26) = (y(12)/y(10))^(params(4)-1);
T(27) = T(2)*(params(4)-1)*(1-params(11))*y(18)^params(9)/params(4);
T(28) = T(27)^(1-params(4));
T(29) = params(4)/((1-params(11))*y(17))*T(28);
T(30) = 1/T(7);
T(31) = params(12)*(y(31)/params(25))^params(39);
T(32) = (y(32)/params(27))^params(40);
T(33) = (y(21)^(1-params(2))-1)/(1-params(2));
