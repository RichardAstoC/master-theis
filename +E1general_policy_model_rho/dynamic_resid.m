...
residual(9) = lhs - rhs;
lhs = y(11)^(params(4)-1);
rhs = T(14)*(1-T(13))*(1-y(30))*y(6)+T(19)*(1-params(12))*T(13);
residual(10) = lhs - rhs;
lhs = y(17);
rhs = y(21)+y(18)+y(16);
residual(11) = lhs - rhs;
lhs = y(15);
rhs = T(13)*params(12)*y(17)*T(20);
residual(12) = lhs - rhs;
lhs = y(16);
rhs = (1-T(13))*y(6)*y(30)*y(17)*T(21);
residual(13) = lhs - rhs;
lhs = y(14);
rhs = T(23)*T(24);
residual(14) = lhs - rhs;
...
residual(20) = lhs - rhs;
lhs = y(30);
rhs = params(11)*(y(21)/params(28))^params(39);
residual(21) = lhs - rhs;
lhs = y(27);
rhs = T(31);
residual(22) = lhs - rhs;
lhs = y(26);
rhs = T(31)+params(1)*y(31);
residual(23) = lhs - rhs;
lhs = y(28);
