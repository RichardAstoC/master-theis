function [tau_star]=B1tau_static_exercise_function(cntry,alpha,epsilon,wf,ff,fe,theta,rho,E,xm,ms)
...
for i=1:dim(2)
    ...
    disp(['tau= ', num2str(t),' | ','H2= ', num2str(H2)])
...
%% calculando el valor óptimo de tau
maximun=find(w2==max(w2))+5;
tau_star=x2(maximun);
end
