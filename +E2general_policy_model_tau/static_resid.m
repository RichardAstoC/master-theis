...
if T_flag
    T = E2general_policy_model_tau.static_resid_tt(T, y, x, params);
end
residual = zeros(25, 1);
lhs = T(1);
...
residual(9) = lhs - rhs;
lhs = y(6)^(params(4)-1);
rhs = T(12)*(1-T(11))*(1-params(11))*y(1)+T(17)*(1-y(25))*T(11);
residual(10) = lhs - rhs;
lhs = y(12);
rhs = y(16)+y(13)+y(11);
residual(11) = lhs - rhs;
lhs = y(10);
rhs = T(11)*y(25)*y(12)*T(18);
residual(12) = lhs - rhs;
lhs = y(11);
rhs = (1-T(11))*y(1)*params(11)*y(12)*T(19);
residual(13) = lhs - rhs;
lhs = y(9);
rhs = T(20)*T(21);
residual(14) = lhs - rhs;
