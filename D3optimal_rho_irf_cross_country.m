...
save OC_FLEX_PAN_RHO oo_ M_;
%cargo datos para graficar irfs
load OC_FLEX_PAN_RHO
oo_PAN = oo_;
M_PAN  = M_;
...
save OC_FLEX_BRA_RHO oo_ M_;
%cargo datos para graficar irfs
load OC_FLEX_BRA_RHO
oo_BRA = oo_;
M_BRA  = M_;
...
save OC_FLEX_IDN_RHO oo_ M_;
%cargo datos para graficar irfs
load OC_FLEX_IDN_RHO
oo_IDN = oo_;
M_IDN  = M_;
